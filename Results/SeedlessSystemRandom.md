...
This file contains the results of testing with System.Random when no seed is passed to the constructor.

Initially, I informally ran all the tests a few times without really tracking how many times or detailed results.
This gave me the impression that System.Random in .NET 8.0 is a pretty good PRNG.
